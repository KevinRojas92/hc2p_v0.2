...
let scroll = document.querySelector('.mascara_proyecto_zapata');
let contadorSig = [];
let contadorAnt = [];
let ancho = 200;
...
function IrAlSiguiente () {
    ...
    } else if (contadorSig.length == 11) {
        scroll.style.marginLeft = "-1000" - "100" + "%";
    } else if (contadorSig.length == 12) {
        scroll.style.marginLeft = "-1100" - "100" + "%";
    } else if (contadorSig.length == 13) {
        scroll.style.marginLeft = "-1200" - "100" + "%";
    } else if (contadorSig.length == 14) {
        scroll.style.marginLeft = "-1300" - "100" + "%";
    } else if (contadorSig.length == 15) {
        scroll.style.marginLeft = "-1400" - "100" + "%";
...
function IrAlAnterior () {
    if (contadorSig.length == 1) {
        ...
        scroll.style.marginLeft = "-1000%";
        contadorSig.pop();
        siguiente.classList.remove("ocultar");
    } else if (contadorSig.length == 12) {
        scroll.style.marginLeft = "-1100%";
        contadorSig.pop();
        siguiente.classList.remove("ocultar");
    } else if (contadorSig.length == 13) {
        scroll.style.marginLeft = "-1200%";
        contadorSig.pop();
        siguiente.classList.remove("ocultar");
    } else if (contadorSig.length == 14) {
        scroll.style.marginLeft = "-1300%";
        contadorSig.pop();
        siguiente.classList.remove("ocultar");
    } else if (contadorSig.length == 15) {
        scroll.style.marginLeft = "-1400%";
        contadorSig.pop();
        siguiente.classList.remove("ocultar");
